...
<div id="main">
  ...
  <div class="page-content">
    <a href="rekap/cetak_program.php?tj=program&aidi=<?php echo $_SESSION['ses_id'] ?>&years=<?php echo $_POST['selectYears'] ?>"
      class="btn btn-primary" target="_blank"><i class="fa fa-fw fa-print"></i> Print</a>
              ...
              <table class="table table-striped" id="program212">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="?page=rekapDonasi&idKode=<?php echo $value['id'] ?>"
                        class="btn btn-primary btn-sm">Detail Donasi</a></td>
                  </tr>
                  <?php
                      $no++;
                    }
