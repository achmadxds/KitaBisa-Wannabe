  ...
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="form-group">
          <label for="inputnim" class="col-lg-2 control-label">Program</label>
          <select class="form-control" name="tahun" id="tahun">
          <option value="">- Pilih -</option>
                <?php
                  $p = mysqli_query($con, "select id, kdProgram, nmProgram FROM program WHERE idLembaga='$data_id' AND idLevel='1'") or die(mysqli_error($con));
